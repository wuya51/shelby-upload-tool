        ...
        <header className="mb-8">
          <div className="flex items-center justify-center space-x-6">
            <div className="p-3 bg-blue-100 rounded-full animate-pulse">
              <img src="https://api.shelbynet.shelby.xyz/shelby/v1/blobs/0x41da761b21d995d2b11616638e48f22342e2a48c5f739517a6e447a13ad5814e/shelbylogo.png" alt="Logo" className="w-10 h-10 object-cover rounded-full" />
            </div>
        ...
        <footer className="bg-white rounded-xl shadow-lg p-8 text-center">
          <div className="flex justify-center mb-6">
            <div className="w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center">
              <img src="https://api.shelbynet.shelby.xyz/shelby/v1/blobs/0x41da761b21d995d2b11616638e48f22342e2a48c5f739517a6e447a13ad5814e/shelbylogo.png" alt="Logo" className="w-8 h-8 object-cover rounded-full" />
            </div>
          </div>
              ...
              <div className="flex items-center">
                <div className="flex-shrink-0 flex items-center">
                  <div className="w-8 h-8 rounded-full overflow-hidden mr-2">
                    <img src="https://api.shelbynet.shelby.xyz/shelby/v1/blobs/0x41da761b21d995d2b11616638e48f22342e2a48c5f739517a6e447a13ad5814e/shelbylogo.png" alt="Logo" className="w-full h-full object-cover rounded-full" />
                  </div>
              ...
              <div className="flex items-center">
                {connected ? (
                  ...
                  <div className="relative">
                    ...
                    {showConnectMenu && (
                      <div className="absolute right-0 mt-2 w-64 bg-gray-800 rounded-lg shadow-xl z-500 border border-gray-700 md:w-56">
                        <div className="py-2">
